                                                ...
                                                <Panel bsStyle="primary" style={{ marginTop: 15 }}>
                                                    ...
                                                    <Panel.Body>
                                                        <input
                                                            ...
                                                            onChange={(event) => { this.props.handleTypeChange(currentTypeIndex, event); }}
                                                        />
                                                                                                            ...
                                                                                                            <Grid fluid={true}>
                                                                                                                <Row className="show-grid">
                                                                                                                    <Col md={6} sm={12}>
                                                                                                                        ...
                                                                                                                        <input type="text" className="form-control" value={currentExampleValue.inEnglish.value} onChange={(event) => { this.props.handleExampleInEnglishChange(currentTypeIndex, currentMeaningAndExampleIndex, currentExampleIndex, event); }} />
                                                                                                                        <div className="text-danger">{currentExampleValue.inEnglish.message}</div>
                                                                                                                    </Col>
                                                                                                                    <Col md={6} sm={12}>
                                                                                                                        <label>Tiếng Việt</label>
                                                                                                                        <input type="text" className="form-control" value={currentExampleValue.inVietnamese.value} onChange={(event) => { this.props.handleExampleInVietnameseChange(currentTypeIndex, currentMeaningAndExampleIndex, currentExampleIndex, event); }} />
